      ...
      <div className='wrapper'>
          ...
          <BrowserRouter>
                <Switch>
                    ...
                    <Route path='/recover-password-page' component={Recover_password_page} exact/>
                    <Route path='/lock-screen-page' component={Lock_screen_page} exact/>
                    ...
                    <div>
                      ...
                      <div className='right-side'>
                              ...
                              <Route path='/ui-tabs&accordions' component={TabAccordions} exact/>
                              ...
                              <Route path='/forms-validation' component={Formvalidation} exact/>
                              ...
                              <Route path='/tables-responsive' component={Responsivetable} exact/>
                              ...
                              <Route path='/directory-page' component={Directory_page} exact/>


                              {/* Icons 
                              <Route path='/icons-matrial' component={Mdi_icons} exact/>
                              <Route path='/icons-ion' component={Ion_icons} exact/>
                              <Route path='/icons-fontawesome' component={Fontawesome_icons} exact/>
