          ...
          <div className="row text-center">
            ...
            <div className="col-md-3">
              ...
              <div>
                ...
                <button
                  className="btn btn-secondary"
                  onClick={() => setcustomewarningAlert(true)}
                >
                  Click me
                </button>
              </div>
            ...
            <div className="col-md-3">
              ...
              <div className="mb-5">
                ...
                >
                  ...
                  lorem erat, tincidunt vitae ipsum et, pellentesque maximus
                  enim. Mauris eleifend ex semper, lobortis purus sed, pharetra
                  felis
                </SweetAlert>
                <p className="mb-2 text-muted">A title with a text under</p>
                <button
                  className="btn btn-secondary"
                  onClick={() => settextAlert(true)}
                >
                  Click me
                </button>
              </div>
              ...
              <div>
                ...
                <button
                  className="btn btn-secondary"
                  onClick={() => setcustomimageAlert(true)}
                >
                  Click me
                </button>
              </div>
            ...
            <div className="col-md-3">
              ...
              <div>
                <SweetAlert
                  ...
                  onConfirm={() =>
                    setTimeout(setautomaticloseAlert(false), 2000)
                  }
                  timeout={2000}
                ...
                <button
                  className="btn btn-secondary"
                  onClick={() => setautomaticloseAlert(true)}
                >
                  Click me
                </button>
              </div>
